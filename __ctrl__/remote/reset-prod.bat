...
for %%V in (fast-nuxt_db-data fast-nuxt_redis-data) do (
...
for %%I in (fast-nuxt-backend:prod fast-nuxt-frontend:prod) do (
...
echo.
echo Start fresh: fast-nuxt-ctrl.bat prod start
endlocal
